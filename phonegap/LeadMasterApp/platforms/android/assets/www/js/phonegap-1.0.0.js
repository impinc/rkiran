...
// 
		...
		// PhoneGap.exec(function(timeout) {
...
if (!PhoneGap.hasResource("app")) {
	PhoneGap.addResource("app"); ( function() {
...
if (!PhoneGap.hasResource("file")) {
	...
	var FileReader = function() {
		...
		// While reading (and decoding) file or fileBlob data, and reporting partial file data (progess.loaded/progress.total)
		this.onload = null;
