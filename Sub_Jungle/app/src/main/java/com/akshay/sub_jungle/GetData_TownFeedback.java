 ...
 */
public class GetData_TownFeedback extends AsyncTask<String, String, ArrayList> {
    ...
    public GetData_TownFeedback(Context context, String sessionId, ListView listView) {
    ...
    protected ArrayList doInBackground(String... params) {
        ...
        try {
            ...
            String req_data= URLEncoder.encode("_operation", "UTF-8") +"="+ URLEncoder.encode("listModuleRecords","UTF-8")
                    ...
                    +"&"+URLEncoder.encode("module","UTF-8") +"="+ URLEncoder.encode("Fbm","UTF-8");
        ...
        Log.e("Output TownFeedback", temp1);
    ...
    protected void onPostExecute(ArrayList s) {
        ...
        if(web2msg.equals("true"))
        {
            ArrayAdapter adb=new ArrayAdapter(context,android.R.layout.simple_list_item_1,s);
            lv.setAdapter(adb);
        }else
        {
            Toast.makeText(context,"Permission to perform the operation is denied",Toast.LENGTH_LONG).show();
        }
